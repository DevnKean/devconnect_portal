...
class BuildAssetsCommand extends ContainerAwareCommand
{
    ...
    protected function configure()
    {
        $this->setName('avanzu:admin:build-assets')
             ...
             ->addOption('uglifyjs-bin',false, InputOption::VALUE_OPTIONAL, 'uglifyjs binary', '/usr/local/bin/uglifyjs')
             ->addOption('uglifycss-bin', false, InputOption::VALUE_OPTIONAL, 'uglifycss binary', '/usr/local/bin/uglifycss')
        ;
